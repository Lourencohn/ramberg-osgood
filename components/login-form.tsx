...
export function LoginForm({
  ...
  return (
    <div className={cn('flex flex-col gap-5', className)} {...props}>
      <div className="rounded-md border border-foreground/15 bg-card p-6 shadow-sm">
          ...
          <FieldGroup>
            <Field>
              <Button
                variant="outline"
                type="button"
                className="h-11 gap-2 border-foreground/15 hover:bg-muted"
              >
            ...
            <FieldSeparator className="*:data-[slot=field-separator-content]:bg-card">
              <span className="label-caps">ou com e-mail</span>
            </FieldSeparator>
            ...
            <Field>
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-xs font-medium text-copper-deep hover:underline"
                >
                  Esqueceu sua senha?
                </a>
              </div>
            ...
            <Field>
              ...
              <FieldDescription className="text-center">
                Não tem uma conta?{' '}
                <a href="/signup" className="font-medium text-copper-deep hover:underline">
                  Cadastre-se
                </a>
              </FieldDescription>
            </Field>
      ...
      <FieldDescription className="px-2 text-center text-xs leading-relaxed">
        ...
        <a href="#" className="text-copper-deep hover:underline">
          Termos de Serviço
        </a>{' '}
        e a{' '}
        <a href="#" className="text-copper-deep hover:underline">
